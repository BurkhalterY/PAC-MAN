        ...
        switch (blinky.getEtat()) {
            ...
            case Scatter:
                break;
            case Peur:
                blinky.setCiblePeur(pacman.getX(), pacman.getY());
                break;
            case Retour:
                break;
            case AttenteBleu:
        ...
        switch (pinky.getEtat()) {
            ...
            case Scatter:
                break;
            case Peur:
                pinky.setCiblePeur(pacman.getX(), pacman.getY());
                break;
            case Retour:
                break;
            case AttenteBleu:
        ...
        switch (inky.getEtat()) {
            ...
            case Scatter:
                break;
            case Peur:
                inky.setCiblePeur(pacman.getX(), pacman.getY());
                break;
            case Retour:
                break;
            case AttenteBleu:
        ...
        switch (clyde.getEtat()) {
            ...
            case Scatter:
                break;
            case Peur:
                clyde.setCiblePeur(pacman.getX(), pacman.getY());
                break;
            case Retour:
                break;
            case AttenteBleu:
